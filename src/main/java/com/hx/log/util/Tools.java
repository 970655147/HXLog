...
//	public static long LOG_ON_MINE_CONF = LOG_ON_ALL;
     ...
     * 线程池的实例
     */
    public static ScheduledThreadPoolExecutor THREAD_POOL = new ScheduledThreadPoolExecutor(N_THREADS);
    ...
    /**
     * 估计的文件的行数 [Tools.getContentWithList]
     */
...
//	}
    ...
    public static void setNThread(int nThread) {
        ...
        if (isThreadPoolRunning(THREAD_POOL)) {
            Log.err("the THREAD_POOL is running NOW, please try again later !");
            return;
        }

        N_THREADS = nThread;
        THREAD_POOL = new ScheduledThreadPoolExecutor(N_THREADS);
    }
    ...
    public static ScheduledFuture<?> schedule(Runnable command, long delay, TimeUnit unit) {
        return THREAD_POOL.schedule(command, delay, unit);
    }

    public static <V> ScheduledFuture<V> schedule(Callable<V> callable, long delay, TimeUnit unit) {
        return THREAD_POOL.schedule(callable, delay, unit);
    }

    public static ScheduledFuture<?> scheduleAtFixedRate(Runnable command, long initialDelay, long period, TimeUnit unit) {
        return THREAD_POOL.scheduleAtFixedRate(command, initialDelay, period, unit);
    }

    public static ScheduledFuture<?> scheduleWithFixedDelay(Runnable command, long initialDelay, long delay, TimeUnit unit) {
        return THREAD_POOL.scheduleWithFixedDelay(command, initialDelay, delay, unit);
    }
    ...
    public static void getNeededFrom(JSONArray spec, JSONObject product, String name, String value, Map<String, String> getInSpec) {
        JSONUtils.extractValueAsKv(spec, product, name, value, getInSpec);
    }
...
//		try {
//			THREAD_POOL.awaitTermination(timout, unit);
...
//	}
    ...
    public static void awaitShutdown() {
        awaitShutdown(THREAD_POOL, CHECK_INTERVAL);
    }
    ...
    public static void awaitTasksEnd() {
        awaitTasksEnd(THREAD_POOL, CHECK_INTERVAL, false);
    }
